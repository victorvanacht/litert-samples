...
android {
  namespace = "com.google.ai.edge.examples.victortestcpp"
  compileSdk = 36
  ...
  defaultConfig {
    applicationId = "com.google.ai.edge.examples.victortestcpp"
    minSdk = 23
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
...
tasks.configureEach {
  if (name == "assembleDebug") {
    doLast {
      ...
      val namedApk = layout.buildDirectory.file("outputs/apk/debug/victortestcpp.apk").get().asFile
