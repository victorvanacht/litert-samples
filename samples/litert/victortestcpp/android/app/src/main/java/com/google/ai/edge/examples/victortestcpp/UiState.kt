...
data class UiState(
  ...
  val gpuBackend: GpuBackend = GpuBackend.OPENCL,
  val gpuPriority: GpuPriority = GpuPriority.HIGH,
  val gpuBufferStorageType: GpuBufferStorageType = GpuBufferStorageType.BUFFER,
